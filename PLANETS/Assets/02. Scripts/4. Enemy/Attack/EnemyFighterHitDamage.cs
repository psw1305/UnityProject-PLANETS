...
public class EnemyFighterHitDamage : MonoBehaviour
{
    delegate void Move();
    event Move Action;
    ...
    {
        GameObject[] enemys = GameObject.FindGameObjectsWithTag("EnemyFighter");
    ...
    void FixedUpdate()
    {
        if (host != null && FindClosestEnemy() != null && !isDestroy)
        {
            Action();
